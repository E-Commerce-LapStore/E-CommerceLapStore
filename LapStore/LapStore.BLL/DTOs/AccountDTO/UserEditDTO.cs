...
namespace LapStore.BLL.DTOs.AccountDTO
{
    public class UserEditDTO
    {
        ...
        public static UserEditDTO FromUser(User user)
        {
            return new UserEditDTO
            {
                ...
                Address = user.address != null ? AddressDTO.FromAddress(user.address) : new AddressDTO()
            };
        }

        public static void UpdateUserFromEditVM(UserEditDTO vm, User user)
        {
